...
const resizeIt = (widthInPixels, filename, context, inputBlob)=>{
...
module.exports = (context, eventGridEvent, inputBlob) => {  
  ...
  const blobName = blobUrl.slice(blobUrl.lastIndexOf("/")+1, -4);
  let filename = blobName + '-240.jpg';
  resizeIt(240, filename, context, inputBlob);

  filename = blobName + '-48.jpg';
  resizeIt(48, filename, context, inputBlob);

  filename = blobName + '-32.jpg';
  resizeIt(32, filename, context, inputBlob);
};